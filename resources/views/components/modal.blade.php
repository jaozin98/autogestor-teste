...
<div x-data="{
    ...
    x-on:keydown.shift.tab.prevent="prevFocusable().focus()" x-show="show" class="modal-overlay"
    style="display: {{ $show ? 'block' : 'none' }};">

    <div x-show="show" class="modal-backdrop" x-on:click="show = false" x-transition:enter="modal-enter"
    ...
    <div x-show="show" class="modal-content" x-transition:enter="modal-enter"
        x-transition:enter-start="modal-enter-start" x-transition:enter-end="modal-enter-end"
        x-transition:leave="modal-leave" x-transition:leave-start="modal-leave-start"
        x-transition:leave-end="modal-leave-end">
        {{ $slot }}
